...
const Productos = [
    {
        ...
        descripción: "<div class='sub'> Incluye: </div> <p> Punta de diamante, extracciónes, mascaras y perfilado de cejas </p>",
    ...
    },
    {
        ...
        descripción: "<div class='sub'> Incluye: </div> <p> Limpieza, exfoliación, y los activos a electroporar",
        otraInfo:"También te damos asesoramiento en el cuidado personal",
        modoDeUso: "<p> Sesión de una hora </p>"  
    },
    {
        ...
        descripción: "<div class='sub'> Incluye: </div> <p> Una primera limpieza profunda, con punta de diamente, con la colocación del ácido a convenir y tres sesiones posteriores</p>",
        otraInfo:"",
...

    {
        ...
        precio: 15000,
        img: "./img/productos/peeling.jpeg",
        descripción: "<div class='sub'> Incluye: </div> <p> Una primera limpieza profunda, con punta de diamente, con la colocación del ácido a convenir y siete sesiones posteriores</p>",
        otraInfo:"",
        modoDeUso: "Sesiones de 40 minutos"  
    },
    ...
    
    {
        ...
        precio: 1070,
        img: "./img/productos/jabon_liquido.png",
        descripción: "Limpia los poros en forma suave y profunda dejando el rostro libre de brillo e impurezas.",
        otraInfo:"<div class='sub'> ACTIVOS: </div> <p>Sepicontrol A5®</p> <p> Acido salicílico</p> <p>Sauce blanco</p> <p>Caléndula</p>",
        modoDeUso: "<div class='sub'> MODO DE USO: </div> Aplicar sobre el rostro humedecido con masajes suaves hasta formar espuma y enjuagar."
    },

    {
        ...
        Categoría: Categorias[1],
        precio: 720,
        img: "./img/productos/leche_de_limpieza.png",
        ...
        otraInfo:"<div class='sub'> Ingredientes activos: </div> <p> Filtros UVB y UVA. Ectoína, Extracto de células de levaduras, Manteca de karité, ADN vegetal y Aloe vera.</p> <p>Tipo de piel:  Todo tipo de piel.</p>",
        modoDeUso: "<div class='sub'> ¿Por qué es diferente?  </div><p>· Multibenefit, protección de amplio espectro, hidratación y antioxidación</p> <p>· Máximos niveles de protección UVA</p> <p>· Ligera coloración que disimula imperfecciones</p> <p>· Producto OTC según normas FDA</p> <p>· PABA Free</p> <p>· Mineral Oil Free</p> <p>· Paraben Free </p>"
    },
...

    {
        ...
        descripción: " <div class='sub'> BENEFICIOS:  </div><p> ■ Hidratación inmediata que permanece por 24 horas.  </p><p>■ Tiene propiedades calmantes y desensibilizantes. </p> <p> ■ Refresca y brinda luminosidad.</p><p> ■ Refuerza la barrera cutánea </p> ",
        otraInfo:"<div class='sub'> PRINCIPIOS ACTIVOS </div> <p> Agua termal</p><p>Remineralizante</p> <p> Soja activa de alta pureza </p><p> Hidratante y muy antioxidante debido al alto contenido de vitaminas, minerales y sobre todo isoflavonas. </p> <p> Estimula la producción de proteínas en la dermis y promueve su reparación. </p>",
        modoDeUso: "<div class='sub'> MODO DE USO </div> <p> Luego de realizar la rutina diaria de higiene y tonificación, colocar una pequeña cantidad de producto y masajear hasta total su absorción en rostro, cuello y escote. </p>"
    },

    {
    	...
    	Categoría: Categorias[3],
    	precio: 1360,
    	img: "./img/productos/nutrisomas.png",
        ...
        otraInfo:"<div class='sub'> . Por función: </div> Humectación, Arrugas profundas, Arrugas finas, Hombre, Antioxidantes </p> <p> . Tipo de piel: Seca, Normal </p><p> . Para pieles: Con arrugas y/o lí­neas de expresión, Involutivas, Fotodañadas, Deshidratadas </p>",
    	modoDeUso: "<div class='sub'> Efecto: </div> <p> Antiage, Humectante, Antioxidante, Reparador </p> <p> . Tipo: Rostro </p>"
...

    {
    	...
    	precio: 1531,
    	img: "./img/productos/complejo_rejuvenecedor.png",
        ...
        otraInfo:"<div class='sub'> Ingredientes activos:</div> <p> Alfahidroxiacidos de origen vegetal: Ácido glicólico, láctico, cítrico, málico y tartárico, Vitamina E y Fosfolípidos purificados de lecitina de Soja. </p> ",
    	modoDeUso: "<div class='sub'> Tipo de piel:</div> <p> Todo tipo de piel, especialmente pieles maduras. </p><p> ¿Por qué es diferente? </p> <p> · Blend de ácidos renovadores </p><p> · Activos liposomados </p> <p> · Mineral Oil Free</p>"
    },
...

    {
        ...
        Categoría: [Categorias[4],Categorias[5] ],
        precio: 1594,
        img: "./img/productos/gel_cream_renovadora.png",
    ...
    },
    {
        ...
        Categoría: [Categorias[4],Categorias[5] ],
        precio: 1594,
        img: "./img/productos/crema_activa_renovadora.png",
        descripción: "Renueva las células superficiales del estrato córneo. Homogeniza, atenúa hiperpigmentaciones y mejora la textura de la piel.",
        otraInfo:" <div class='sub'>PRINCIPIOS ACTIVOS</div> </p>Ácido glicólico<p></p> <p> Ácido mandélico</p><p>Ácido cítrico (Alfahidroxiácidos)</p> <p> Ácido salicílico (betahidroxiácido) </p> Ácido lipoico<p> Ácido fítico. </p> <p>Piel normal y seca. </p> ",
        modoDeUso: "<div class='sub'> Porque es diferente: </div> Multibenefit, 4 ácidos exfoliantes y 2 antioxidantes <p> Formulación biotecnológica, microesponjas que evitan el shock de pH cutáneo </p> Mineral Oil Free <p> Paraben Free </p><p> MODO DE USO: </p><p> Se recomienda utilizar durante la noche. Durante el día complementar con la Crema Renovadora (COD.923) u otros productos hidratantes y protección solar. La piel que lisa, luminosa y homogénea. Sus Componentes ayudan a evitar los signos del envejecimiento prematuro de la piel </p>"
    },
...

    {
        ...
        precio: 1611,
        img: "./img/productos/vitamina_c_eyes_serum.png",
        ...
        otraInfo:"<div class='sub'>PRINCIPIOS ACTIVOS</dvi> <p> 5% Vitamina C AA2G</p> <p>3% Lipomoist 2036</p><p>0,2% Vitamina A + E</p> <p> 1% Proteínas de soja </p> <p> 0,5% Colágeno </p>",
        modoDeUso: "<div class='sub'>MODO DE USO: </div> <p> Desplazar el aplicador masajeador con suavidad por el contorno de los ojos, previamente limpios y tonificados, de forma lenta hasta total absorción.</p><p> Luego colocar el producto de tratamiento habitual y/o maquillaje. Se puede utilizar por la mañana y por la noche. </p>"
    },
    ...
    
    {
        ...
        Categoría: Categorias[6],
        precio: 1087,
        img: "./img/productos/gel_contorno_ojos.png",
        ...
        otraInfo:"<div class='sub'>PRINCIPIOS ACTIVOS</div> <p> Gel de Aloe vera. </p> <p>Extractos de Malva y Hamamelis</p><p>Esferas vitaminizadas (Vitamina A y E)</p> <p> Clorofilina.</p>",
        modoDeUso: "<div class='sub'>¿Por qué es diferente?</div> <p>  · Contiene uniesferas de vitaminas</p><p>· Mineral Oil Free </p>"
    },
    {
        id: 22,
    ...
    },
    {
    	...
    	precio: 825,
    	img: "./img/productos/ampollas.png",
    	...
    	modoDeUso: "<div class='sub'>  Modo de empleo: </div> <p>  Uso tópico exclusivo. Aplicar con un suave masaje. Mejora su efectividad si se usa conjuntamente con mesoterapia transadérmica por electroporación </p>"
    },
    {
        id: 26,
        ...
        precio: 1087,
        img: "./img/productos/protector_spf.png",
        ...
        otraInfo:"<div class='sub'>PRINCIPIOS ACTIVOS</div> <p> 5% Vitamina C AA2G</p> <p>3% Lipomoist 2036</p><p>0,2% Vitamina A + E</p> <p> 1% Proteínas de soja </p> <p> 0,5% Colágeno </p>",
        modoDeUso: "<div class='sub'>MODO DE USO: </div> <p> Desplazar el aplicador masajeador con suavidad por el contorno de los ojos, previamente limpios y tonificados, de forma lenta hasta total absorción.</p><p> Luego colocar el producto de tratamiento habitual y/o maquillaje. Se puede utilizar por la mañana y por la noche. </p>"
    }
